...
const TaskDialog = ({ task }) => {
  ...
  const [duplicateTask] = useDuplicateTaskMutation();  // Define duplicate mutation hook

  // Handle duplication of task
  ...
  const items = [
    ...
    },
    {
      ...
      onClick: duplicateHandler,  // Corrected duplicateHandler call
    },
  ];
  ...
  return (
    <>
      ...
      <AddTask
        ...
        setOpen={setOpenEdit}
        task={task}
        key={new Date().getTime()} // Ensure key changes on each render for re-mount
      />
